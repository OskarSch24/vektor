  ...
  return (
    ...
    >
      <div
        ...
        tabIndex={-1}
        className={`apple-modal w-full ${className} bg-[#151720]/95 border border-white/[0.12] rounded-2xl shadow-apple-window overflow-hidden flex flex-col focus:outline-none`}
      >
