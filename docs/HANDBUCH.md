> Deutsches Handbuch zu Vektor · [← zurück zur README](../README.md)
...
Die neuen Formate öffnen im vorhandenen Tab. **Ansicht** bietet dort zusätzlich Datensatz, Tabellenbeziehungen, Diagramme, Pivot, Zeitstrahl, Kalender, Kanban, Karte, Galerie, Vergleich, Datenqualität und Vektoren. Details und Verbindungsdateien: [Dateien öffnen](dateien-oeffnen.md).
